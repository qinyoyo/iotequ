...
public class PayPosController  {
	...
	public ResponseEntity<Map<String, Object>> updateSelective(@RequestBody List<Map<String,Object>> payPosList, HttpServletRequest request, HttpServletResponse response) {
		try {

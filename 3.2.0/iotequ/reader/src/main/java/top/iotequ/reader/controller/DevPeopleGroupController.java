...
public class DevPeopleGroupController  {
	...
	public ResponseEntity<Map<String, Object>> updateSelective(@RequestBody List<Map<String,Object>> devPeopleGroupList, HttpServletRequest request, HttpServletResponse response) {
		try {

...
@RestController
@RequestMapping("/reader/devNewDevice")
public class DevNewDeviceController  {
	private static final Logger log = LoggerFactory.getLogger(DevNewDeviceController.class);
	@Autowired
	ICgService<DevNewDevice> cgService;

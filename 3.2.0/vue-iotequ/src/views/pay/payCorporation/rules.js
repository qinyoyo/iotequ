...
export default  {
   ...
   getRules: function(obj, rec) {
      ...
      return Object.assign({
         name:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('payCorporation.field.name'), trigger: 'blur' }
         ],
         address:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('payCorporation.field.address'), trigger: 'blur' }
         ],
         linkman:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('payCorporation.field.linkman'), trigger: 'blur' }
         ],
         linkphone:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('payCorporation.field.linkphone'), trigger: 'blur' }
         ],

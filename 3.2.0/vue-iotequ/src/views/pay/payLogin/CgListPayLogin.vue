...
<template>
  <div :class="joinMode?'cg-join-list':'cg-list'">
    ...
    >
      ...
      <cg-table-column prop="batchNo" :page="paginationCurrentPage" :label="$t('payLogin.field.batchNo')" sortable :sort-method="(a,b)=>chineseSort(a.batchNo,b.batchNo)" align="left" >
        <template slot-scope="scope">
          {{ scope.row.batchNo }}
        </template>

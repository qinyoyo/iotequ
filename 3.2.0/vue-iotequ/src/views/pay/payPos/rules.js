...
export default  {
   ...
   getRules: function(obj, rec) {
      ...
      return Object.assign({
         no:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('payPos.field.no'), trigger: 'blur' }
         ],
         shopId:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('payPos.field.shopId'), trigger: 'blur' }
         ],
         ewalletActive:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('payPos.field.ewalletActive'), trigger: 'blur' }
         ],

...
<template>
  <div :class="joinMode?'cg-join-list':'cg-list'">
    ...
    >
      ...
      <cg-table-column prop="deviceNo" :page="paginationCurrentPage" :label="$t('ewDevice.field.deviceNo')" sortable :sort-method="(a,b)=>chineseSort(a.deviceNo,b.deviceNo)" align="left" >
        <template slot-scope="scope">
          {{ scope.row.deviceNo }}
        </template>

      </cg-table-column>
      <cg-table-column prop="shopId" :page="paginationCurrentPage" :label="$t('ewDevice.field.shopId')" sortable :sort-method="(a,b)=>chineseSort(a.shopId,b.shopId)" align="left" >
        <template slot-scope="scope">
          {{ scope.row.shopId }}
        </template>

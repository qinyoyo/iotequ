...
export default  {
   ...
   getRules: function(obj, rec) {
      ...
      return Object.assign({
         name:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('adSpecialShiftTime.field.name'), trigger: 'blur' }
         ],
         startTime:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('adSpecialShiftTime.field.startTime'), trigger: 'blur' }
         ],
         endTime:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('adSpecialShiftTime.field.endTime'), trigger: 'blur' }
         ],

...
export default  {
   ...
   getRules: function(obj, rec) {
      ...
      return Object.assign({
         endDate:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('adException.field.endDate'), trigger: 'blur' }
         ],
         startDate:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('adException.field.startDate'), trigger: 'blur' }
         ],
         weekDay:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('adException.field.weekDay'), trigger: 'blur' }
         ],

      ...
      <el-row :gutter="mobile?0:20">
        <el-col :span="12">
          <cg-join v-model="hrJoinVisible" :readonly="isDetail" >
            ...
            <el-form-item class="cg-item-mltext" slot="reference" :label="$t('sysUser.field.realName')" prop="hrName" :size="$store.state.app.size" >
              <cg-input v-model="record.hrName" name="hrName" 
                        type="mltext" 
                        :label="$t('sysUser.field.realName')" :placeholder="$t('system.message.unknown')" 
                        resize autofocus validate-event 
                        readonly :maxlength="32" show-word-limit clearable />
            </el-form-item>
          </cg-join>
        ...
        <el-col :span="12">
          <cg-join v-model="managerJoinVisible" :readonly="isDetail" >
            ...
            <el-form-item class="cg-item-mltext" slot="reference" :label="$t('sysUser.field.realName')" prop="managerName" :size="$store.state.app.size" >

...
export default  {
   ...
   getRules: function(obj, rec) {
      ...
      return Object.assign({
         sortNum:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('sysMenu.field.sortNum'), trigger: 'blur' }
         ],
         name:[
         ...
         isDivider:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('sysMenu.field.isDivider'), trigger: 'blur' }
         ],
         mobileHidden:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('sysMenu.field.mobileHidden'), trigger: 'blur' }
         ],

...
<template>
  <div :class="joinMode?'cg-join-list':'cg-list'">
    ...
    >
      ...
      <el-table-column prop="name" width="200" :label="$t('sysOrg.field.name')" sortable :sort-method="(a,b)=>chineseSort(a.name,b.name)" align="left" >
      ...
      <cg-table-column prop="phone" :page="1" :label="$t('sysOrg.field.phone')" sortable :sort-method="(a,b)=>chineseSort(a.phone,b.phone)" align="left" >
        <template slot-scope="scope">

  ...
  <div :class="mobile || height==0 ? 'cg-form':'cg-form just-v-scroll'" :style="mobile || height==0?'':'height:'+height+'px'">
    <el-form ref="cgForm" v-loading="recordLoading" :model="record" v-cg-form-adjust
      ...
      <cg-join v-model="readerSelectionJoinVisible" :readonly="isDetail" >
        ...
        <el-form-item v-if="record.deviceSelectionMode=='2'" class="cg-item-mltext" slot="reference" :label="$t('devReader.field.name')" prop="readerName" :size="$store.state.app.size" >
      ...
      <cg-join v-model="userSelectionJoinVisible" :readonly="isDetail" >
        ...
        <el-form-item v-if="record.userSelectionMode=='2'" class="cg-item-text" slot="reference" :label="$t('devPeople.field.realName')" prop="userName" :size="$store.state.app.size" >
...
const Comp = {
  ...
  data() {
    return {
      ...
      dictionary: {
        dictOperation: this.getDictionary('upload,download,remove','devData.field.operation_0,devData.field.operation_1,devData.field.operation_2'),
        dictDeviceSelectionMode: this.getDictionary('1,2','devData.field.deviceSelectionMode_0,devData.field.deviceSelectionMode_1'),
        dictGroupSelection: [],
        dictUserSelectionMode: this.getDictionary('1,2','devData.field.userSelectionMode_0,devData.field.userSelectionMode_1'),
        dictOrgSelection: []
      },

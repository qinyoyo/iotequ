...
export default  {
   ...
   getRules: function(obj, rec) {
      ...
      return Object.assign({
         name:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('devAuthGroup.field.name'), trigger: 'blur' }
         ],
         auth:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('devAuthGroup.field.auth'), trigger: 'blur' }
         ],

<template>
  <div class="cg-list cg-list-devReader">
    <el-card shadow="hover">
      ...
      <CgListDevReader ref="cgList" :height="clientHeight" @detail="doShowDetail" :fixedQueryRecord="fixedQueryRecord"/>
    </el-card>
  </div>
</template>

<script>
import CgListDevReader from './CgListDevReader.vue'
import ParentList from '@/views/common-views/components/list'
const Comp = {
  name: 'DevReaderList',
  components: { CgListDevReader },
  mixins: [ParentList],
  data() {
    return {
      path: 'list',

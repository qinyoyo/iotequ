      ...
      <el-tabs ref="tabs" v-model="tabSelected" @tab-click="autoFocus">
        <el-tab-pane :label="groupPaneTitle('devReader.title.groupDevReaderName')">
          <el-row :gutter="mobile?0:20">
            <el-col :span="8">
              <el-form-item class="cg-item-mltext cg-auto-focus" :label="$t('devReader.field.name')" prop="name" :size="$store.state.app.size" >
            ...
            <el-col :span="8">
              <el-form-item :label="labelForNo()" class="cg-item-text" prop="readerNo" :size="$store.state.app.size" >
                <el-input v-model="record.readerNo" name="readerNo" 
                          @dblclick.native="selectNewDevice()"
                          type="text" 
        ...
        <el-tab-pane :label="groupPaneTitle('devReader.title.groupDevReaderWgOrder')">
          ...
          <el-row :gutter="mobile?0:20">
            ...
            <el-col :span="8">
              <el-form-item class="cg-item-text" :label="$t('devReader.field.capacity')" prop="capacity" :size="$store.state.app.size" >
                <el-input v-model="record.capacity" name="capacity" 
                          type="text" 
                          :label="$t('devReader.field.capacity')" :placeholder="$t('system.message.unknown')" 
                          resize autofocus validate-event 
                          readonly :maxlength="10" show-word-limit clearable />
              </el-form-item>
            </el-col>
          </el-row>
        </el-tab-pane>

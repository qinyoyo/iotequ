...
export default  {
   ...
   getRules: function(obj, rec) {
      ...
      return Object.assign({
         readerNo:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('devPeopleMapping.field.readerNo'), trigger: 'blur' }
         ],
         userNo:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('devPeopleMapping.field.userNo'), trigger: 'blur' }
         ],
         status:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('devPeopleMapping.field.status'), trigger: 'blur' }
         ],

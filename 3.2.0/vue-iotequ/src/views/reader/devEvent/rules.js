...
export default  {
   ...
   getRules: function(obj, rec) {
      ...
      return Object.assign({
         devType:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('devEvent.field.devType'), trigger: 'blur' }
         ],
         devNo:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('devEvent.field.devNo'), trigger: 'blur' }
         ],
         time:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('devEvent.field.time'), trigger: 'blur' }
         ],

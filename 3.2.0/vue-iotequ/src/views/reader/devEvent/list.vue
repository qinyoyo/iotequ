<template>
  <div class="cg-list cg-list-devEvent">
    <el-card shadow="hover">
      ...
      <CgListDevEvent ref="cgList" :height="clientHeight" @detail="doShowDetail" :fixedQueryRecord="fixedQueryRecord"/>
    </el-card>
  </div>
</template>

<script>
import CgListDevEvent from './CgListDevEvent.vue'
import ParentList from '@/views/common-views/components/list'
const Comp = {
  name: 'DevEventList',
  components: { CgListDevEvent },
  mixins: [ParentList],
  data() {
    return {
      path: 'list',

...
<template>
  <div :class="joinMode?'cg-join-list':'cg-list'">
    ...
    >
      ...
      <cg-table-column prop="name" :page="paginationCurrentPage" :label="$t('pmProject.field.name')" sortable :sort-method="(a,b)=>chineseSort(a.name,b.name)" align="left" >
      ...
      <cg-table-column prop="customer" :page="paginationCurrentPage" :label="$t('pmProject.field.customer')" sortable :sort-method="(a,b)=>chineseSort(a.customer,b.customer)" align="left" >
        <template slot-scope="scope">
          {{ scope.row.customer }}
        </template>

...
public class EwDeviceController  {
	...
	public ResponseEntity<Map<String, Object>> updateSelective(@RequestBody List<EwDevice> ewDeviceList, HttpServletRequest request, HttpServletResponse response) {
		try {

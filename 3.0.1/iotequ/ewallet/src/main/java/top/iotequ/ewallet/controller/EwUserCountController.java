...
public class EwUserCountController  {
	...
	public ResponseEntity<Map<String, Object>> updateSelective(@RequestBody List<EwUserCount> ewUserCountList, HttpServletRequest request, HttpServletResponse response) {
		try {

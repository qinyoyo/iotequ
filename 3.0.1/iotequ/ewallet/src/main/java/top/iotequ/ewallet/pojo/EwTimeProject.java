...
//  Pojo entity : EwTimeProject (计时消费项目)
@CgTableAnnotation(name="ew_time_project",
                   title="ewTimeProject",
...
@Getter
@Setter
public class EwTimeProject implements CgEntity {
    ...
    private Double bonusPoint;		//基本单元默认积分 db field:bonus_point

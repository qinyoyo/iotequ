...
public class EwUserTimeController  {
	...
	public ResponseEntity<Map<String, Object>> updateSelective(@RequestBody List<EwUserTime> ewUserTimeList, HttpServletRequest request, HttpServletResponse response) {
		try {

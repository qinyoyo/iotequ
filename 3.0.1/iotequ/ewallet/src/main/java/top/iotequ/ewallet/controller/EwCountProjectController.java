...
public class EwCountProjectController  {
	...
	public ResponseEntity<Map<String, Object>> updateSelective(@RequestBody List<EwCountProject> ewCountProjectList, HttpServletRequest request, HttpServletResponse response) {
		try {

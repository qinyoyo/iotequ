...
public class CgListFieldController  {
	...
	public ResponseEntity<Map<String, Object>> updateSelective(@RequestBody List<CgListField> cgListFieldList, HttpServletRequest request, HttpServletResponse response) {
		try {

...
public class DevPeopleController  {
	...
	public ResponseEntity<Map<String, Object>> updateSelective(@RequestBody List<DevPeople> devPeopleList, HttpServletRequest request, HttpServletResponse response) {
		try {

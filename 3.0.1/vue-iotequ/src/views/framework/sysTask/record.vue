<template>
  <div class="cg-form cg-form-sysTask">
    <el-dialog ref="dialog" v-el-drag-dialog :visible.sync="showDialog" top="0px" :class="'cg-form cg-form-sysTask'+(dialogClass?' '+dialogClass:'')" :close-on-click-modal="false"

<template>
  <div class="cg-form cg-form-sysOauthClientDetails">
    <el-dialog ref="dialog" v-el-drag-dialog :visible.sync="showDialog" top="0px" :class="'cg-form cg-form-sysOauthClientDetails'+(dialogClass?' '+dialogClass:'')" :close-on-click-modal="false"
...
import CgFormOauthClientDetails from './CgFormOauthClientDetails'
const Comp = {
  name: 'OauthClientDetailsForm',
  components: { CgFormOauthClientDetails },
  mixins: [ParentForm],
  data() {
    return {
      path: 'record',

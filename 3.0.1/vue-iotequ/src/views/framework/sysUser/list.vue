<template>
  <div class="cg-list">
    <el-card shadow="hover">
      ...
      <CgListUser ref="cgList" :height="clientHeight" @detail="doShowDetail" @rowClick="rowClick"/>
    </el-card>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    content() {
      return this.$t('sysUser.title.list') + (!this.mobile && this.contentSubTitle?' - '+this.contentSubTitle:'')
    }
  },
  methods: {
    goBack() {

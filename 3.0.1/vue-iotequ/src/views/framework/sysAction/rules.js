...
export default  {
   ...
   getRules: function(obj, rec) {
      ...
      return Object.assign({
         value:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('sysAction.field.value'), trigger: 'blur' }
         ],
         method:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('sysAction.field.method'), trigger: 'blur' }
         ],

<template>
  <div class="cg-form cg-form-sysRole">
    <el-dialog ref="dialog" v-el-drag-dialog :visible.sync="showDialog" top="0px" :class="'cg-form cg-form-sysRole'+(dialogClass?' '+dialogClass:'')" :close-on-click-modal="false"

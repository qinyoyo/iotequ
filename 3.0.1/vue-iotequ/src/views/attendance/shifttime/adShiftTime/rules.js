...
export default  {
   ...
   getRules: function(obj, rec) {
      ...
      return Object.assign({
         name:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('adShiftTime.field.name'), trigger: 'blur' }
         ],
         weekDays:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('adShiftTime.field.weekDays'), trigger: 'blur' }
         ],
         startWorkTime:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('adShiftTime.field.startWorkTime'), trigger: 'blur' }
         ],
         endWorkTime:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('adShiftTime.field.endWorkTime'), trigger: 'blur' }
         ],

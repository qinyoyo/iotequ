<template>
  <div class="cg-form">
    <el-card shadow="hover">
      ...
      <CgFormAdSpecialShiftTime ref="cgForm"
...
export default {
  ...
  computed: {
    ...
    content() {
      ...
      else return this.$t('adSpecialShiftTime.title.'+this.path)
    },
    title() {

  ...
  <div :class="joinMode?'cg-join-list':'cg-list'">
    ...
    <cg-query-condition v-model="showQuery" ref="query" :modal="!joinMode" :queryRecord="queryRecord"
      ...
      <el-form-item v-show="queryRecord.search" :label="$t('system.action.field')" prop="searchFields" :size="$store.state.app.size">
        <cg-select v-model="queryRecord.searchFields" dictionary="dateDate|adData.field.dateDate,realName|sysUser.field.realName,recType|adData.field.recType,recSourceType|adData.field.recSourceType,recSource|adData.field.recSource," multiple/>
      </el-form-item>
      <el-divider />
      <div v-show="!queryRecord.search">
        ...
        <el-form-item slot="reference" :label="$t('sysUser.field.realName')" prop="realName" :size="$store.state.app.size">
          <cg-input v-model="queryRecord.realName" type="text" name="realName"
                    :readonly="fixedQueryRecord.realName?true:false" :label="$t('sysUser.field.realName')" clearable resize autofocus @clear="clearJoinValues(myself,'employeeNoJoin')"/>
        </el-form-item>
        </cg-join>

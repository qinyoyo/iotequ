<template>
  <div class="cg-list">
    <el-card shadow="hover">
      ...
      <CgListAdData ref="cgList" :height="clientHeight" @detail="doShowDetail" :fixedQueryRecord="fixedQueryRecord"/>
    </el-card>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    content() {
      return this.$t('adData.title.list')
    }
  },
  methods: {
    goBack() {

    ...
    <el-form ref="cgForm" v-loading="recordLoading" :model="record" v-cg-form-adjust
      ...
      <el-tabs ref="tabs" v-model="tabSelected" @tab-click="autoFocus">
        <el-tab-pane :label="groupPaneTitle('system.action.detail')">
          <el-row :gutter="mobile?0:20">
            ...
            <el-col :span="8">
              <cg-join v-model="flowRegisterByJoinVisible" readonly >
                ...
                <el-form-item class="cg-item-mltext" slot="reference" :label="$t('sysUser.field.registerByName')" prop="registerByName" :size="$store.state.app.size" >
                  <cg-input v-model="record.registerByName" name="registerByName" 
                            type="mltext" 
                            :label="$t('sysUser.field.registerByName')" :placeholder="$t('system.message.needValue')" 
          ...
          <el-row :gutter="mobile?0:20">
            <el-col :span="8">
              <el-form-item class="cg-item-select" :label="$t('pmVersionApplication.field.applicationType')" prop="applicationType" :size="$store.state.app.size" >
                <cg-select v-model="record.applicationType" name="applicationType"
                           :dictionary="dictionary.dictApplicationType" readonly :filterable="false" :allow-create="false" numberic :placeholder="$t('system.message.needValue')" />
              </el-form-item>
            </el-col>
            <el-col :span="16">
              <el-form-item class="cg-item-select" :label="$t('pmVersionApplication.field.project')" prop="project" :size="$store.state.app.size" >
                <cg-select v-model="record.project" name="project"
                           :dictionary="dictionary.dictProject" readonly :filterable="false" :allow-create="false" :placeholder="$t('system.message.needValue')" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="mobile?0:20">
          ...
          <el-form-item class="cg-item-textarea cg-auto-focus" :label="$t('pmVersionApplication.field.versionInfo')" prop="versionInfo" :size="$store.state.app.size" >
...
const mixins = [Comp]
const mixinContext = require.context('.', false, /CgFormPmVersionFlow-mixin\.(js|vue)$/)

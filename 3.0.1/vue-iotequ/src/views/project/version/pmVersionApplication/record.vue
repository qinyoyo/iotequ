<template>
  <div class="cg-form cg-form-pmVersionApplication">
    <el-dialog ref="dialog" v-el-drag-dialog :visible.sync="showDialog" top="0px" :class="'cg-form cg-form-pmVersionApplication'+(dialogClass?' '+dialogClass:'')" :close-on-click-modal="false"

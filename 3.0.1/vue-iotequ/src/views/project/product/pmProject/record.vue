<template>
  <div class="cg-form cg-form-pmProject">
    <el-dialog ref="dialog" v-el-drag-dialog :visible.sync="showDialog" top="0px" :class="'cg-form cg-form-pmProject'+(dialogClass?' '+dialogClass:'')" :close-on-click-modal="false"
...
import CgFormPmProject from './CgFormPmProject'
const Comp = {
  name: 'PmProjectForm',
  components: { CgFormPmProject },
  mixins: [ParentForm],
  data() {
    return {

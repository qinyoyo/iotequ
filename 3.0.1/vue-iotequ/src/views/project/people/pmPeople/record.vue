<template>
  <div class="cg-form cg-form-pmPeople">
    <el-dialog ref="dialog" v-el-drag-dialog :visible.sync="showDialog" top="0px" :class="'cg-form cg-form-pmPeople'+(dialogClass?' '+dialogClass:'')" :close-on-click-modal="false"
...
import CgFormPmPeople from './CgFormPmPeople'
const Comp = {
  name: 'PmPeopleForm',
  components: { CgFormPmPeople },
  mixins: [ParentForm],
  data() {
    return {

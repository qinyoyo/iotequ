...
export default  {
   ...
   getRules: function(obj, rec) {
      ...
      return Object.assign({
         name:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('pmPeopleGroup.field.name'), trigger: 'blur' }
         ],
         groupType:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('pmPeopleGroup.field.groupType'), trigger: 'blur' }
         ],
         enabled:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('pmPeopleGroup.field.enabled'), trigger: 'blur' }
         ],

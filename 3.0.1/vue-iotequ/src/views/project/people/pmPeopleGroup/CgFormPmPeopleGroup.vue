    ...
    <el-form ref="cgForm" v-loading="recordLoading" :model="record" v-cg-form-adjust
      ...
      <el-form-item class="cg-item-text" :label="$t('pmPeopleGroup.field.description')" prop="description" :size="$store.state.app.size" >
        <el-input v-model="record.description" name="description" 
                  ...
                  :label="$t('pmPeopleGroup.field.description')" :placeholder="$t('system.message.unknown')" clearable 
                  :readonly="isDetail" resize autofocus validate-event />
      </el-form-item>
    </el-form>
...
export default {
  ...
  data() {
    return {
      myself: this,
      path: 'record',
      title: this.$t('pmPeopleGroup.title.'+this.path),
      rules: {},
      idField: 'id',
  ...
  computed: {
    ...
    className() {
      return (this.mobile?'cg-form-cell ':'')+'cg-no-border cg-form-pmpeoplegroup'
    },
    labelWidth() {

...
export default {
  ...
  computed: {
    ...
    icon() {
      ...
      else return 'el-icon-mouse'
    },
    content() {
      if (this.$route.query.content) return this.$route.query.content
      else return this.$t('cgButton.title.'+this.path)
    },
    title() {

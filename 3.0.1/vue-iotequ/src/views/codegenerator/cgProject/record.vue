<template>
  <div class="cg-form cg-form-cgProject">
    <el-dialog ref="dialog" v-el-drag-dialog :visible.sync="showDialog" top="0px" :class="'cg-form cg-form-cgProject'+(dialogClass?' '+dialogClass:'')" :close-on-click-modal="false"
...
import CgFormCgProject from './CgFormCgProject'
const Comp = {
  name: 'CgProjectForm',
  components: { CgFormCgProject },
  mixins: [ParentForm],
  data() {
    return {
      path: 'record',

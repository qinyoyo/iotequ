...
<template>
  <div :class="joinMode?'cg-join-list':'cg-list'">
    ...
    >
      ...
      <cg-table-column prop="entityField" :page="1" :label="$t('cgFormField.field.entityField')" sortable align="left" >
...
export default {
  ...
  data() {
    return {
      ...
      rulesObject,
      path: 'list',
      title: this.$t('cgFormField.title.list'),
      showQuery: false,
  ...
  computed: {
    ...
    className() {
      return this.openID ? 'cg-list-cgformfield cg-list-cgformfield' + '-'+this.openID : 'cg-list-cgformfield'
    },
    additionalActions() {

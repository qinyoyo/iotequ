...
<template>
  <div :class="joinMode?'cg-join-list':'cg-list'">
    ...
    >
      ...
      <cg-table-column prop="entityField" :page="1" :label="$t('cgListField.field.entityField')" sortable :sort-method="(a,b)=>chineseSort(a.entityField,b.entityField)" align="left" >

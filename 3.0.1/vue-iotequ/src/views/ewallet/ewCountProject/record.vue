<template>
  <div class="cg-form cg-form-ewCountProject">
    <el-dialog ref="dialog" v-el-drag-dialog :visible.sync="showDialog" top="0px" :class="'cg-form cg-form-ewCountProject'+(dialogClass?' '+dialogClass:'')" :close-on-click-modal="false"
      ...
      <CgFormEwCountProject ref="cgForm"
...
import CgFormEwCountProject from './CgFormEwCountProject'
const Comp = {
  name: 'EwCountProjectForm',
  components: { CgFormEwCountProject },
  mixins: [ParentForm],
  data() {
    return {
      path: 'record',

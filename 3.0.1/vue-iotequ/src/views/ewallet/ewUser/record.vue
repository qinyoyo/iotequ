<template>
  <div class="cg-form cg-form-ewUser">
    <el-dialog ref="dialog" v-el-drag-dialog :visible.sync="showDialog" top="0px" :class="'cg-form cg-form-ewUser'+(dialogClass?' '+dialogClass:'')" :close-on-click-modal="false"
...
import CgFormEwUser from './CgFormEwUser'
const Comp = {
  name: 'EwUserForm',
  components: { CgFormEwUser },
  mixins: [ParentForm],
  data() {
    return {
      path: 'record',

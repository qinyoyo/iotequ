...
<template>
  <div :class="joinMode?'cg-join-list':'cg-list'">
    ...
    >
      ...
      <cg-table-column prop="name" :page="paginationCurrentPage" :label="$t('ewUser.field.name')" sortable :sort-method="(a,b)=>chineseSort(a.name,b.name)" align="left" >
        <template slot-scope="scope">
          {{ scope.row.name }}
        </template>
      ...
      <cg-table-column prop="idNo" :page="paginationCurrentPage" :label="$t('ewUser.field.idNo')" sortable :sort-method="(a,b)=>chineseSort(a.idNo,b.idNo)" align="left" >
        <template slot-scope="scope">
          {{ scope.row.idNo }}
        </template>

      </cg-table-column>
      <cg-table-column prop="mobilePhone" :page="paginationCurrentPage" :label="$t('ewUser.field.mobilePhone')" sortable :sort-method="(a,b)=>chineseSort(a.mobilePhone,b.mobilePhone)" align="left" >
        <template slot-scope="scope">
          {{ scope.row.mobilePhone }}
        </template>

      </cg-table-column>
      <cg-table-column prop="email" :page="paginationCurrentPage" :label="$t('ewUser.field.email')" sortable :sort-method="(a,b)=>chineseSort(a.email,b.email)" align="left" >
        <template slot-scope="scope">
          {{ scope.row.email }}
        </template>
      ...
      <cg-table-column prop="memberGroup" :page="paginationCurrentPage" :label="$t('ewUser.field.memberGroup')" sortable :sort-method="(a,b)=>chineseSort(a.memberGroup,b.memberGroup)" align="left" >
        <template slot-scope="scope">

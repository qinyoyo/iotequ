...
<template>
  <div :class="joinMode?'cg-join-list':'cg-list'">
    ...
    >
      ...
      <cg-table-column prop="userNo" :page="paginationCurrentPage" :label="$t('ewUserTime.field.userNo')" sortable :sort-method="(a,b)=>chineseSort(a.userNo,b.userNo)" align="left" >

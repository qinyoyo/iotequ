<template>
  <div class="cg-list cg-list-ewUserTime">
    <el-card shadow="hover">
      ...
      <CgListEwUserTime ref="cgList" :height="clientHeight" @detail="doShowDetail" :fixedQueryRecord="fixedQueryRecord"/>
    </el-card>
  </div>
</template>

<script>
import CgListEwUserTime from './CgListEwUserTime.vue'
import ParentList from '@/views/common-views/components/list'
const Comp = {
  name: 'EwUserTimeList',
  components: { CgListEwUserTime },
  mixins: [ParentList],
  data() {
    return {
      path: 'list',

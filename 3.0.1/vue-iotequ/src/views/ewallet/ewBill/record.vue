<template>
  <div class="cg-form cg-form-ewBill">
    <el-dialog ref="dialog" v-el-drag-dialog :visible.sync="showDialog" top="0px" :class="'cg-form cg-form-ewBill'+(dialogClass?' '+dialogClass:'')" :close-on-click-modal="false"

...
<template>
  <div :class="joinMode?'cg-join-list':'cg-list'">
    ...
    >
      ...
      <cg-table-column prop="no" :page="paginationCurrentPage" :label="$t('ewBill.field.no')" sortable :sort-method="(a,b)=>chineseSort(a.no,b.no)" align="left" >
      ...
      <cg-table-column prop="userNo" :page="paginationCurrentPage" :label="$t('ewBill.field.userNo')" sortable :sort-method="(a,b)=>chineseSort(a.userNo,b.userNo)" align="left" >
        <template slot-scope="scope">
          {{ scope.row.userNo }}
        </template>
      ...
      <cg-table-column prop="shopId" :page="paginationCurrentPage" :label="$t('ewBill.field.shopId')" sortable :sort-method="(a,b)=>chineseSort(a.shopId,b.shopId)" align="left" >
        <template slot-scope="scope">
          {{ scope.row.shopId }}
        </template>
      ...
      <cg-table-column prop="operatorNo" :page="paginationCurrentPage" :label="$t('ewBill.field.operatorNo')" sortable :sort-method="(a,b)=>chineseSort(a.operatorNo,b.operatorNo)" align="left" >
        <template slot-scope="scope">

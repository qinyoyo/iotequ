<template>
  <div class="cg-form cg-form-ewDevice">
    <el-dialog ref="dialog" v-el-drag-dialog :visible.sync="showDialog" top="0px" :class="'cg-form cg-form-ewDevice'+(dialogClass?' '+dialogClass:'')" :close-on-click-modal="false"

<template>
  <div class="cg-list">
    <el-card shadow="hover">
      ...
      <CgListEwDevice ref="cgList" :height="clientHeight" @detail="doShowDetail" :fixedQueryRecord="fixedQueryRecord"/>
    </el-card>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    content() {
      return this.$t('ewDevice.title.list')
    }
  },
  methods: {
    goBack() {

<template>
  <div class="cg-form cg-form-ewUserCount">
    <el-dialog ref="dialog" v-el-drag-dialog :visible.sync="showDialog" top="0px" :class="'cg-form cg-form-ewUserCount'+(dialogClass?' '+dialogClass:'')" :close-on-click-modal="false"
...
import CgFormEwUserCount from './CgFormEwUserCount'
const Comp = {
  name: 'EwUserCountForm',
  components: { CgFormEwUserCount },
  mixins: [ParentForm],
  data() {
    return {

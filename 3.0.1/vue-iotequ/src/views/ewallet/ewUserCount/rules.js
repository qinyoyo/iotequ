...
export default  {
   ...
   getRules: function(obj, rec) {
      ...
      return Object.assign({
         amountCount:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('ewUserCount.field.amountCount'), trigger: 'blur' }
         ],
         costLimit:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('ewUserCount.field.costLimit'), trigger: 'blur' }
         ],
         dayLimit:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('ewUserCount.field.dayLimit'), trigger: 'blur' }
         ],

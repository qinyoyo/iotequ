<template>
  <div class="cg-list cg-list-ckSignIn">
    <el-card shadow="hover">
      ...
      <CgListSignIn ref="cgList" :height="clientHeight" @detail="doShowDetail" :fixedQueryRecord="fixedQueryRecord"/>
    </el-card>
  </div>
</template>

<script>
import CgListSignIn from './CgListSignIn.vue'
import ParentList from '@/views/common-views/components/list'
const Comp = {
  name: 'SignInList',
  components: { CgListSignIn },
  mixins: [ParentList],
  data() {
    return {
      path: 'list',

<template>
  <div class="cg-list cg-list-devDownloadPlan">
    <el-card shadow="hover">
      ...
      <CgListDownloadPlan ref="cgList" :height="clientHeight" @detail="doShowDetail" :fixedQueryRecord="fixedQueryRecord"/>
    </el-card>
  </div>
</template>

<script>
import CgListDownloadPlan from './CgListDownloadPlan.vue'
import ParentList from '@/views/common-views/components/list'
const Comp = {
  name: 'DownloadPlanList',
  components: { CgListDownloadPlan },
  mixins: [ParentList],
  data() {
    return {

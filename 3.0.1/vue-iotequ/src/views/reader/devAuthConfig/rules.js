...
export default  {
   ...
   getRules: function(obj, rec) {
      ...
      return Object.assign({
         onlyWorkDay:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('devAuthConfig.field.onlyWorkDay'), trigger: 'blur' }
         ],
         auth:[
            { required: true, message: vueObject.$t('system.message.needValue') + ':' + vueObject.$t('devAuthConfig.field.auth'), trigger: 'blur' }
         ],

<template>
  <div class="cg-form cg-form-devReaderGroup">
    <el-dialog ref="dialog" v-el-drag-dialog :visible.sync="showDialog" top="0px" :class="'cg-form cg-form-devReaderGroup'+(dialogClass?' '+dialogClass:'')" :close-on-click-modal="false"
      ...
      <CgFormDevReaderGroup ref="cgForm"
...
import CgFormDevReaderGroup from './CgFormDevReaderGroup'
const Comp = {
  name: 'DevReaderGroupForm',
  components: { CgFormDevReaderGroup },
  mixins: [ParentForm],
  data() {
    return {
      path: 'record',

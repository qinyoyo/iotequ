<template>
  <div class="cg-form cg-form-devReader">
    <el-dialog ref="dialog" v-el-drag-dialog :visible.sync="showDialog" top="0px" :class="'cg-form cg-form-devReader'+(dialogClass?' '+dialogClass:'')" :close-on-click-modal="false"
...
import CgFormDevReader from './CgFormDevReader'
const Comp = {
  name: 'DevReaderForm',
  components: { CgFormDevReader },
  mixins: [ParentForm],
  data() {
    return {
      path: 'record',

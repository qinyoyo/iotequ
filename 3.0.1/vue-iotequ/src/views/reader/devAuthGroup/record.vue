<template>
  <div class="cg-form cg-form-devAuthGroup">
    <el-dialog ref="dialog" v-el-drag-dialog :visible.sync="showDialog" top="0px" :class="'cg-form cg-form-devAuthGroup'+(dialogClass?' '+dialogClass:'')" :close-on-click-modal="false"

      ...
      <el-row :gutter="mobile?0:20">
        ...
        <el-col :span="8">
          <cg-join v-model="userNoJoinVisible" :readonly="isDetail" >
            ...
            <el-form-item class="cg-item-text" slot="reference" :label="$t('devEvent.field.userNo')" prop="realName" :size="$store.state.app.size" >
      ...
      <el-row :gutter="mobile?0:20">
        ...
        <el-col :span="8">
          <cg-join v-model="auditorUserNumJoinVisible" :readonly="isDetail" >
            ...
            <el-form-item class="cg-item-text" slot="reference" :label="$t('devEvent.field.auditorName')" prop="auditorName" :size="$store.state.app.size" >

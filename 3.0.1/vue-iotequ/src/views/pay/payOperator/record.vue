<template>
  <div class="cg-form cg-form-payOperator">
    <el-dialog ref="dialog" v-el-drag-dialog :visible.sync="showDialog" top="0px" :class="'cg-form cg-form-payOperator'+(dialogClass?' '+dialogClass:'')" :close-on-click-modal="false"
...
import CgFormPayOperator from './CgFormPayOperator'
const Comp = {
  name: 'PayOperatorForm',
  components: { CgFormPayOperator },
  mixins: [ParentForm],
  data() {
    return {
      path: 'record',

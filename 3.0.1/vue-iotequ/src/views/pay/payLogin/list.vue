<template>
  <div class="cg-list">
    <el-card shadow="hover">
      ...
      <CgListPayLogin ref="cgList" :height="clientHeight" @detail="doShowDetail" :fixedQueryRecord="fixedQueryRecord"/>
    </el-card>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    content() {
      return this.$t('payLogin.title.list')
    }
  },
  methods: {
    goBack() {

<template>
  <div class="cg-form cg-form-payCorporation">
    <el-dialog ref="dialog" v-el-drag-dialog :visible.sync="showDialog" top="0px" :class="'cg-form cg-form-payCorporation'+(dialogClass?' '+dialogClass:'')" :close-on-click-modal="false"
      ...
      <CgFormPayCorporation ref="cgForm"
...
import CgFormPayCorporation from './CgFormPayCorporation'
const Comp = {
  name: 'PayCorporationForm',
  components: { CgFormPayCorporation },
  mixins: [ParentForm],
  data() {
    return {
      path: 'record',

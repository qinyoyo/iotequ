<template>
  <div class="cg-list">
    <el-card shadow="hover">
      ...
      <CgListPayCorporation ref="cgList" :height="clientHeight" @detail="doShowDetail" :fixedQueryRecord="fixedQueryRecord"/>
    </el-card>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    content() {
      return this.$t('payCorporation.title.list')
    }
  },
  methods: {
    goBack() {

<template>
  <div class="cg-form cg-form-payShop">
    <el-dialog ref="dialog" v-el-drag-dialog :visible.sync="showDialog" top="0px" :class="'cg-form cg-form-payShop'+(dialogClass?' '+dialogClass:'')" :close-on-click-modal="false"

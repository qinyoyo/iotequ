<template>
  <div class="cg-list">
    <el-card shadow="hover">
      ...
      <CgListPayShop ref="cgList" :height="clientHeight" @detail="doShowDetail" :fixedQueryRecord="fixedQueryRecord"/>
    </el-card>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    content() {
      return this.$t('payShop.title.list')
    }
  },
  methods: {
    goBack() {

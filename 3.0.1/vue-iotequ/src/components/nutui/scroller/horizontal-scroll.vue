<template>
    <div class="nut-hor-scroll cg-mobile-scroller" ref="wrapper">
...
export default {
    ...
    mounted() {
        this.$nextTick(() => {
            this.isShow();
            // 监听
            this.$el.addEventListener('resetScroller', this.reset);
    ...
    beforeDestroy() {
        // 移除监听
        this.$el.removeEventListener('resetScroller', this.reset);

  ...
  <div :class="mobile || height==0 ? 'cg-form':'cg-form just-v-scroll'" :style="mobile || height==0?'':'height:'+height+'px'">
    <el-form ref="cgForm" v-loading="recordLoading" :model="record" v-cg-form-adjust
      ...
      <cg-join v-model="readerSelectionJoinVisible" :readonly="isDetail" >
        ...
        <el-form-item class="cg-item-text" slot="reference" :label="$t('devData.field.readerSelection')" prop="readerName" :size="$store.state.app.size" >
      ...
      <cg-join v-model="userSelectionJoinVisible" :readonly="isDetail" >
        ...
        <el-form-item class="cg-item-text" slot="reference" :label="$t('devData.field.userSelection')" prop="userName" :size="$store.state.app.size" >

...
public class DevReaderController  {
	...
	public ResponseEntity<Map<String, Object>> updateSelective(@RequestBody List<DevReader> devReaderList, HttpServletRequest request, HttpServletResponse response) {
		try {

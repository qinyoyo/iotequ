...
public class DevOrgGroupController  {
	...
	public ResponseEntity<Map<String, Object>> updateSelective(@RequestBody List<DevOrgGroup> devOrgGroupList, HttpServletRequest request, HttpServletResponse response) {
		try {
